...
The `docgen` maintainers take all security issues in the project
seriously. Thank you for improving the security of `docgen`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`docgen` leverages GitHub's private vulnerability reporting.
